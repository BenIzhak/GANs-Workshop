# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 15:03:06 2019
...
for epoch in range(num_epochs):
    ...
    #save model
    checkpoint = {'model': Generator(nn.Module),
          'state_dict': netG.state_dict(),
          'optimizer' : optimizerG.state_dict()}

    torch.save(checkpoint, 'checkpointG.pth')
    
    checkpoint = {'model': Discriminator(nn.Module),
          'state_dict': netD.state_dict(),
          'optimizer' : optimizerD.state_dict()}

    torch.save(checkpoint, 'checkpointD.pth')
